...
contract DegenToken is ERC20, Ownable {
    ...
    constructor() ERC20("Degen", "DGN") Ownable(msg.sender) {
        // Setting item prices
        itemPrices["toblerone"] = 499;
        itemPrices["milka"] = 500;
        itemPrices["dairymilk"] = 350;
        itemPrices["hersheys"] = 285;
        itemPrices["kisses"] = 100;
        
        // Adding item names to the array
        itemNames.push("toblerone");
        itemNames.push("milka");
        itemNames.push("dairymilk");
        itemNames.push("hersheys");
        itemNames.push("kisses");
    }
